(function (window) {
  ...
  function handleOffestTopZero(movingElement) {
    movingElement.classList.remove('up');
    movingElement.classList.add('down');
  }

  function handleOffestTopMaxHeight(movingElement) {
    movingElement.classList.remove('down');
    movingElement.classList.add('up');
  }

  function handleOffestLeftZero(movingElement) {
    movingElement.classList.remove('left');
    movingElement.classList.add('right');
  }

  function handleOffestLeftMaxWidth(movingElement) {
    movingElement.classList.remove('right');
    movingElement.classList.add('left');
  }
